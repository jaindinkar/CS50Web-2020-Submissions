...
function loadPosts(page_no) {
    ...
    .then(page_data => {
        ...
        // Multiple Element Eventing Conundrum (MEEC) (Technique used here)
        ////// ----> (Best.) Link: https://www.kirupa.com/html5/handling_events_for_many_elements.htm
...
function saveEdit(event){
    ...
    ////// 4. If all checks passed update the post on server.
        ...
        .catch(error => {
            ...
            ////// 6. Log the status on console.
            console.log('Couldn\'t update post on server.');
